...
When plan memory is exhausted, new entries will have empty plan text until the total entry count is reached which triggers a garbage collection cycle, freeing up query text records.
